...
и сколько шаблонов упоминают его имя. Флаг `is_deprecated=true` по-прежнему
существует для ранее заархивированных атрибутов — такой атрибут скрывается из
форм и таблиц, но значения в записях остаются.
