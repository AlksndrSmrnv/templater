    ...
    def build_template_field_mapping(
        *,
        ...
        system_prompt = (
            ...
            "НЕ размечай служебные идентификаторы и метаданные сообщения (rquid, operuid,\n"
            "request/operation/message id, correlation id, UUID конверта, временные метки) —\n"
            "это не данные участников, пропускай их.\n"
