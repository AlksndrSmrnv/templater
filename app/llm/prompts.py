...
_FIELD_MAPPING_DEFAULT = (
    ...
    "\n"
    "ВАЖНО (формат ответа):\n"
    "  • В поле leaf указывай ТОЛЬКО короткий id листа (L1, L2, …) — НИКОГДА не "
    "путь и не значение.\n"
    "  • У каждого листа в ответе поле field обязано быть непустым. Если "
    "подходящего поля нет — НЕ добавляй лист в ответ вовсе (не возвращай пустой "
    "field).\n"
    "\n"
